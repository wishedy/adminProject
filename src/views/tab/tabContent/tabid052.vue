        ...
        <section class="adminContentInner">
            <el-form :inline="true" :model="formInline" class="demo-form-inline" label-width="80px" label-position="left">
                <el-form-item label="场景ID">
                    <el-input v-model="formInline.articleId" placeholder="权限ID" class="adminInputEl"></el-input>
                </el-form-item>
                ...
                <el-form-item label="场景状态">
                    <el-select v-model="formInline.isValid" placeholder="权限状态" class="adminInputEl">
                ...
                <el-form-item label="场景状态">
                    <el-select v-model="formInline.isValid" placeholder="权限状态" class="adminInputEl">
                        ...
                        <el-option label="拉黑用户" value="3"></el-option>
                    </el-select>
                </el-form-item>
            ...
            <div class="block">
                <el-main>
                    <el-form :model="ruleForm2" status-icon :rules="rules2" ref="ruleForm2" label-width="100px" class="demo-ruleForm">
                        ...
                        <el-form-item label="游客" prop="checkPass">
                            <el-radio-group v-model="radio2">
                                <el-radio :label="0">允许</el-radio>
                                <el-radio :label="1">不允许</el-radio>
                            </el-radio-group>
                        </el-form-item>
                        <el-form-item label="拉黑用户" prop="checkPass">
                            <el-radio-group v-model="radio2">
                                <el-radio :label="0">允许</el-radio>
                                <el-radio :label="1">不允许</el-radio>
                            </el-radio-group>
                        </el-form-item>
                        <el-form-item label="注册用户" prop="checkPass">
                            <el-radio-group v-model="radio2">
                                <el-radio :label="0">允许</el-radio>
                                <el-radio :label="1">不允许</el-radio>
                            </el-radio-group>
        ...
        data() {
            return {
                ...
                formInline: {
                    ...
                    articleId:'',//该权限的唯一标识
                    articleTitle:'',//权限的标题
                    templateId:'',//权限使用的模板id
                    customerId:'',//该权限的作者id,
                    customerName:'',//该权限的作者Name,
                    'isValid':''//，0无效,1有效
                },
                imageUrl: '',
                ruleForm2: {
                ...
                if(!t.selectedOne){
                    ...
                    if(type===0){
                        ...
                        axios({
                            ...
                            t.$message({
                                message: t.selectedData.articleTitle+'权限已被激活',
                                type: 'success'
                            });
                            t.getArticleList();
                        });
                ...
                if(!t.selectedOne){
                    ...
                    if(type===0){
                        ...
                        axios({
                            ...
                            t.$message({
                                message: t.selectedData.articleTitle+'权限已被无效',
                                type: 'success'
                            });
                            t.getArticleList();
                        });
            ...
            editArticle(type){
                ...
                if(!t.selectedOne){
                    ...
                    if(type===0){
                        ...
                        t.$message({
                            message: t.selectedData.articleTitle+'权限已生成',
                            type: 'success'
                        });
                    }
                }
            ...
            pushContent(type){
                ...
                if(!t.selectedOne){
                    ...
                    if(type===0){
                        ...
                        t.pushOnOff = false;
                        t.$message({
                            message: t.selectedData.articleTitle+'权限已推送',
                            type: 'success'
                        });
                    }
